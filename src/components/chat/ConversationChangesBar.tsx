import { ArrowRight, ChevronDown, FileText, RotateCcw } from "@/components/ui/icons";
...
export function ConversationChangesBar({ change, onViewChanges, onRefresh, onPreviewChange }: { change: ConversationTurnChanges; onViewChanges: () => void; onRefresh: () => void; onPreviewChange: (path: string) => void }) {
